...
public class InvestathonsFragment extends Fragment {
    ...
    private InvestathonsViewModel notificationsViewModel;
    private FragmentInvestathonsBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        notificationsViewModel =
                new ViewModelProvider(this).get(InvestathonsViewModel.class);

        binding = FragmentInvestathonsBinding.inflate(inflater, container, false);
